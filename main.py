...
def Try():
    try:
        buttonc = driver.find_element(By.SELECTOR, '#mde-consent-modal-container > div.sc-iBkjds.frmJSB > div.sc-papXJ.ixHhna > div.sc-jqUVSM.dBIrCF > button')
        buttonc.click()
    except:
        return
Try()
...
Marke_push = driver.find_element(By.SELECTOR, '#root > div > div > article.RSseD._3LZ_7._2iEKW > section > div > div.UiAUP > div > div:nth-child(1) > div > select')
